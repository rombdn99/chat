 ...
 if($statement->execute($check_data)) 
 {
  ...
  else
  {
   ...
   {/*
    ...
    $añadirusuario = new Login($connect);
    $passwordh = str_replace("$","?",password_hash($password, PASSWORD_DEFAULT));
    echo $passwordh;
    $añadirusuario->setusername($username)->setpassword($passwordh)->Save();
   }
  }
 }
}
